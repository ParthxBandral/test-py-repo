...
export default function MedicalSupportPage() {
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl mx-auto pb-24 space-y-20"
    >
      ...
      <section className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12">
        <div className="space-y-8">
          <div className="space-y-4">
            <h2 className="text-3xl font-light tracking-tight">Describe Your Injury</h2>
        ...
        <div className="border border-foreground bg-background p-8 lg:p-12 shadow-2xl relative overflow-hidden">
            ...
            {assessmentStep === 0 && (
              ...
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl font-light">Select affected area</h3>
                </div>
                ...
                <button 
                  ...
                  className="w-full py-5 bg-foreground text-background text-[11px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-4 disabled:opacity-30 transition-opacity"
                >
            ...
            {assessmentStep === 1 && (
              ...
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl font-light">Define Intensity (Pain Scale)</h3>
                </div>
                <div className="space-y-8">
                  ...
                  />
                  <div className="text-center text-7xl font-serif text-foreground">{painLevel}</div>
                </div>
                <div className="flex gap-4">
                  <button onClick={() => setAssessmentStep(0)} className="flex-1 py-5 border border-border text-[11px] font-black uppercase tracking-[0.2em] hover:border-foreground transition-all">Back</button>
                  <button onClick={() => setAssessmentStep(2)} className="flex-[2] py-5 bg-foreground text-background text-[11px] font-black uppercase tracking-[0.3em]">Continue</button>
                </div>
              </motion.div>
            )}
            ...
            {assessmentStep === 2 && (
              ...
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl font-light">Describe the discomfort</h3>
                </div>
                <textarea 
                  value={description}
                ...
                <button 
                  ...
                  className="w-full py-5 bg-foreground text-background text-[11px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-4 overflow-hidden relative"
                >
                  {isAnalyzing ? (
              ...
              >
                <div className="flex items-center justify-between border-b border-border pb-4">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-2xl font-light">Recovery Roadmap</h3>
                  </div>
      ...
      <section className="space-y-12">
        <header className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-border pb-8">
          <div>
            ...
            <h2 className="text-4xl font-light tracking-tight">Recovery & Rehab Experts</h2>
          </div>
          <button className="px-6 py-2 border border-border text-[10px] font-black uppercase tracking-widest hover:border-foreground transition-all">
              ...
              <div className="relative aspect-[4/5] bg-zinc-900 overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-2xl font-light text-white">{expert.name}</h3>
                  </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-red-600/5 border-y border-red-600/20 py-16 px-6 sm:px-10">
        <div className="space-y-6">
           ...
           <h3 className="text-3xl font-light">When to seek urgent care</h3>
        ...
        <div className="flex flex-col justify-center items-start md:items-end space-y-6">
           ...
           <button className="px-10 py-5 border-2 border-red-600 text-red-600 text-[10px] font-black uppercase tracking-[0.3em] hover:bg-red-600 hover:text-white transition-all shadow-[0_0_20px_rgba(220,38,38,0.2)]">
              Activate Bridge
           </button>
        </div>
      </section>
      ...
      {/* Footer Disclaimer */}
      <footer className="pt-10 border-t border-border flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex gap-10 text-[10px] font-black uppercase tracking-widest text-foreground">
